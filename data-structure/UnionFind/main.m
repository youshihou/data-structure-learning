...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        testUnionFind([[QuickUnionRankPathCompression alloc] initWithCapacity:12]);
        ...
        testUnionFindTime([[QuickUnionRankPathCompression alloc] initWithCapacity:count], count);
    }
    return 0;
}
